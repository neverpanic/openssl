    ...
    if (signature->settable_ctx_params != NULL
        ...
        if (signature->gettable_ctx_params != NULL
            ...
            if (gettable_params != NULL
                ...
                OSSL_PARAM params_buf[] = {
                    OSSL_PARAM_construct_utf8_string(param_key, NULL, 0),
                    OSSL_PARAM_END,
                };
        ...
        if (settable_params != NULL
            ...
            if (digest_algs != NULL) {
                OSSL_PARAM digest_algs_params[] = {
                    OSSL_PARAM_construct_utf8_string(param_key, digest_algs, 0),
                    OSSL_PARAM_END
                };
